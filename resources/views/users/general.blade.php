                    ...
                    <form id="general_users" method="POST" action="{{ route('update.general_users', Auth::id()) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if(Auth::user()->country) value="{{ old('country') ?? Auth::user()->country->name }}" @else
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="city" id="city"
                                @if(Auth::user()->city) value="{{ old('city') ?? Auth::user()->city->name }}" @else
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if(Auth::user()->profession) value="{{ old('profession') ?? Auth::user()->profession->name }}" @else
